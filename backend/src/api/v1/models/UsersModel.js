...
const UserSchema = new mongoose.Schema({
    ...
    first_name: { type: String, required: true, minlength: [5, "Name must be 5 char long "], maxlength: [80, "Name mustn't 80 char long"], lowercase: true },

    last_name: { type: String, required: true, minlength: [5, "Name must be 5 char long "], maxlength: [80, "Name mustn't 80 char long"], lowercase: true },
