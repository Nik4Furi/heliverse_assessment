...
const UserSchema = new mongoose.Schema({
    ...
    first_name: { type: String, required: true, minlength: [2, "first name must be 2 char long "], maxlength: [80, "first name mustn't 80 char long"], lowercase: true },

    last_name: { type: String, required: true, minlength: [2, "last name must be 2 char long "], maxlength: [80, "last name mustn't 80 char long"], lowercase: true },
